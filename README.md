...
# THIS IS A TEMPLATE README.md, AND WILL BE EDITED IN DUE COURSE


# My Portfolio - MiniBlog

This is my own personal Portfolio and users Miniblog. As I'm coming to the end of my Diploma in Full-Stack Development with Code-Institute, this is my first personal project. This will be a platform for myself to share my Web Development projects and a place to post mine and others Articles. - MiniBlog.
